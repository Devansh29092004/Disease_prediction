...
export default function DiabetesPredictionPage() {
  ...
  // Watch the gender field to update pregnancies when it changes
  const gender = form.watch("gender");

  // Reset pregnancies to 0 when gender is male
  useEffect(() => {
    if (gender === "1") {
      // Male
      form.setValue("pregnancies", 0);
    }
  }, [gender, form]);
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            ...
                            {...field}
                            disabled={gender === "1"}
                            value={gender === "1" ? "0" : field.value}
                          />
                        </FormControl>
                        {gender === "1" && (
                          <p className="text-xs text-muted-foreground">
                            {/* Locked to zero for male patients */}
                          </p>
                        )}
                        <FormMessage />
                      </FormItem>
          ...
          <CardContent>
            {!result && !isLoading && (
              <div className="flex flex-col items-center justify-center h-64 text-center text-muted-foreground">
                ...
                <p>
                  Submit your health metrics to see a diabetes risk assessment
                </p>
              </div>
            )}
            ...
            {isLoading && (
              <div className="flex flex-col items-center justify-center h-64">
                ...
                <p className="text-muted-foreground">
                  Analyzing your data with ML model...
                </p>
              </div>
            )}
